...
function ConversationList({
  ...
  const conversationRenderer = (conversation: Conversation) => {
    ...
    return (
      ...
      >
        <img
          className="circle w-[40px] h-[40px]"
          src={conversationLead?.image?.serverFilename || DefaultProfileImage}
        />
        <h2>
  ...
  return (
    <div
      className={`bg-white drop-shadow-lg z-10 ${
        loading || conversations.length !== 0 ? "w-[300px]" : ""
      }`}
    >
