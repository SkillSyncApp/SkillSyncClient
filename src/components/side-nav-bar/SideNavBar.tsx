import { ChatBubbleOvalLeftIcon as InboxIconOutlined, Squares2X2Icon as DiscoverIconOutlined, UserCircleIcon as ProfileIconOutlined } from '@heroicons/react/24/outline';
import { ChatBubbleOvalLeftIcon as InboxIconSolid, Squares2X2Icon as DiscoverIconSolid, UserCircleIcon as ProfileIconSolid } from '@heroicons/react/24/solid';
...
function SideNavBar() {
    return <nav className="flex flex-col p-4 text-[18px] gap-2">
        ...
        <NavLink className={({ isActive }) => `nav-item cursor-pointer ${isActive ? 'active' : ''}`} to='/profile'>
            {({ isActive }) => (
